...
const STAGES_JSON = JSON.stringify(WAKE_STAGES);
    ...
    <>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `(function(){var s=${STAGES_JSON},i=0,el=document.getElementById('8bit-wake-stage');if(el){setInterval(function(){i=(i+1)%s.length;el.textContent=s[i];},2400);}setTimeout(function(){var n=document.getElementById('8bit-wake-static');if(n){n.classList.add('wake-bridge--exit');setTimeout(function(){n.remove();},400);}},10000);})();`,
        }}
      />
    </>
  );
